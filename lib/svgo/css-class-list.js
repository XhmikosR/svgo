...
CSSClassList.prototype.add = function (...args) {
  this.hasClass();
  args.forEach(this._addSingle.bind(this));
};
...
CSSClassList.prototype.remove = function (...args) {
  this.hasClass();
  args.forEach(this._removeSingle.bind(this));
};
